...
public class Kiosk {
	 ...
	 * as a string and breaking it apart. First the command is obtain and based on
	 * that input, whatever other input that should follow it to discern the correct
	 * ouptut.
	 */
	public void run() {
		...
		while (true) {
			...
			if (firstChar == 'A') { // executes function to add a book
				try {
